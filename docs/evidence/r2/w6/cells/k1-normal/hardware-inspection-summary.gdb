...
printf "trace_1_nominal_to_decision_cycles=%u\n", (unsigned int)g_r2_w6_result.trace[0].nominal_to_decision_cycles
printf "trace_1_nominal_to_irq_exit_cycles=%u\n", (unsigned int)g_r2_w6_result.trace[0].nominal_to_irq_exit_cycles
printf "trace_1_final_window_cycles=%u\n", (unsigned int)g_r2_w6_result.trace[0].final_window_cycles
printf "trace_1_raw_min=%u\n", (unsigned int)g_r2_w6_result.trace[0].raw_min
printf "trace_1_raw_max=%u\n", (unsigned int)g_r2_w6_result.trace[0].raw_max
...
printf "trace_96_nominal_to_decision_cycles=%u\n", (unsigned int)g_r2_w6_result.trace[95].nominal_to_decision_cycles
printf "trace_96_nominal_to_irq_exit_cycles=%u\n", (unsigned int)g_r2_w6_result.trace[95].nominal_to_irq_exit_cycles
printf "trace_96_final_window_cycles=%u\n", (unsigned int)g_r2_w6_result.trace[95].final_window_cycles
printf "trace_96_raw_min=%u\n", (unsigned int)g_r2_w6_result.trace[95].raw_min
printf "trace_96_raw_max=%u\n", (unsigned int)g_r2_w6_result.trace[95].raw_max
