...
printf "start_dma_cr=0x%08x\n", (unsigned int)g_r2_w6_result.start_dma_cr
printf "start_dma_ndtr=%u\n", (unsigned int)g_r2_w6_result.start_dma_ndtr
printf "start_adc_cr2=0x%08x\n", (unsigned int)g_r2_w6_result.start_adc_cr2
printf "start_tim2_cr1=0x%08x\n", (unsigned int)g_r2_w6_result.start_tim2_cr1

printf "\n=== EVENT ACCOUNTING ===\n"
printf "epoch_before=%u\n", (unsigned int)g_r2_w6_result.epoch_before
printf "epoch_after=%u\n", (unsigned int)g_r2_w6_result.epoch_after
...
printf "buffer0_admitted=%u\n", (unsigned int)g_r2_w6_result.admitted_by_buffer[0]
printf "buffer0_dropped=%u\n", (unsigned int)g_r2_w6_result.dropped_by_buffer[0]
printf "buffer0_processed=%u\n", (unsigned int)g_r2_w6_result.processed_by_buffer[0]
printf "buffer0_released=%u\n", (unsigned int)g_r2_w6_result.released_by_buffer[0]

printf "buffer1_admitted=%u\n", (unsigned int)g_r2_w6_result.admitted_by_buffer[1]
printf "buffer1_dropped=%u\n", (unsigned int)g_r2_w6_result.dropped_by_buffer[1]
printf "buffer1_processed=%u\n", (unsigned int)g_r2_w6_result.processed_by_buffer[1]
printf "buffer1_released=%u\n", (unsigned int)g_r2_w6_result.released_by_buffer[1]

printf "buffer2_admitted=%u\n", (unsigned int)g_r2_w6_result.admitted_by_buffer[2]
printf "buffer2_dropped=%u\n", (unsigned int)g_r2_w6_result.dropped_by_buffer[2]
printf "buffer2_processed=%u\n", (unsigned int)g_r2_w6_result.processed_by_buffer[2]
printf "buffer2_released=%u\n", (unsigned int)g_r2_w6_result.released_by_buffer[2]

printf "\n=== HOOK / QUEUE / ERROR ACCOUNTING ===\n"
...
printf "trace_1_completed_id=%u\n", (unsigned int)g_r2_w6_result.trace[0].completed_id
printf "trace_1_replacement_id=%u\n", (unsigned int)g_r2_w6_result.trace[0].replacement_id
printf "trace_1_mapping_epoch_after=%u\n", (unsigned int)g_r2_w6_result.trace[0].mapping_epoch_after
printf "trace_1_m0_before=0x%08x\n", (unsigned int)g_r2_w6_result.trace[0].m0_before
printf "trace_1_m1_before=0x%08x\n", (unsigned int)g_r2_w6_result.trace[0].m1_before
printf "trace_1_m0_after=0x%08x\n", (unsigned int)g_r2_w6_result.trace[0].m0_after
printf "trace_1_m1_after=0x%08x\n", (unsigned int)g_r2_w6_result.trace[0].m1_after
...
printf "trace_96_completed_id=%u\n", (unsigned int)g_r2_w6_result.trace[95].completed_id
printf "trace_96_replacement_id=%u\n", (unsigned int)g_r2_w6_result.trace[95].replacement_id
printf "trace_96_mapping_epoch_after=%u\n", (unsigned int)g_r2_w6_result.trace[95].mapping_epoch_after
printf "trace_96_m0_before=0x%08x\n", (unsigned int)g_r2_w6_result.trace[95].m0_before
printf "trace_96_m1_before=0x%08x\n", (unsigned int)g_r2_w6_result.trace[95].m1_before
printf "trace_96_m0_after=0x%08x\n", (unsigned int)g_r2_w6_result.trace[95].m0_after
printf "trace_96_m1_after=0x%08x\n", (unsigned int)g_r2_w6_result.trace[95].m1_after
